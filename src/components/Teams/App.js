        ...
        <div className="teamsss" id="second" onClick={this.handleClickb}>
          ...
          {this.state.msgb && (
            <div id="ctp">
              ...
              <p>
                <ul>
                  <li>The team represented India in the University Rover Challenge(URC), 2017 at Utah, USA. They were the top 36 teams across the world that qualified for URC. Anveshak finished 29th out of 36 teams. They also won a sponsorship of $1000 from Protocase Inc. to manufacture future editions of the rover.</li>
                  <li>In its second attempt, Team Anveshak has finished at 25th position at the 12th edition of University Rover Challenge (URC) 2018 that took place at Hanksville, Utah USA from 41 May to 2 June 2018.</li>
                </ul>
              </p>
            </div>
          )}
