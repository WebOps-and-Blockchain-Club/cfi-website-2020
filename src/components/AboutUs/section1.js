              ...
              <div className="main_features fix roomy-70">
                <div className="col-md-6">
                  <div className="head_title">
                    <h2
                      className="text-uppercase font1"
                      style={{ fontSize: "38px" }}
                    >
                  ...
                  <div className="featured_content font2">
                    ...
                    <br />
                    <p className=" font2">
                      Every year, we host the “Open House”, where we throw open
                      our doors to people from all walks of life to come in and
                      interact with us. We’ll have other students, professors,
                      alumni, industrialists, media and more: making the Open
                      House a trove of opportunities for those who seek it.
                    </p>
                    <br />
                    <p className=" font2">
                      Open House 2019 displayed a plethora of innovative
                      projects taken up by our 10 clubs including Artemis- the
                      railroad crack detection bot, Unmanned Aerial Vehicle for
                      disaster management and many others which have bagged
                      national and international honours , as well as work of
                      our 4 internationally acclaimed competition teams – Team
                      Abhiyaan, Team Anveshak, Team Avishkar Hyperloop and
              ...
              <div className="main_service">
                  ...
                  <div className="service_slid">
                    ...
                    <div className="service_slid_item text-center font1">
                      <div className="service_slid_text">
                        <img
                          src={require("./components/images/conf.jpg")}
                          alt=""
                        />
                ...
                <div className="col-md-6 ">
                  <div className="service_item sm-m-top-50">
                    ...
                    <div className=" font2">
                      <p className=" font2">
                        On 13th April 2018, a Press Conference was held to
                        create awareness among the media about the Centre for
                        Innovation, and it’s major competition teams: Team
                        Raftar, Team Anveshak, and Team Abhiyaan.
                      </p>
                      <br />
                      <p className=" font2">
                        The Press Conference was addressed by Prof. Bhaskar
                        Ramamurthi, Director, IIT Madras, Prof. Sivakumar M.
                        Srinivasan, Dean, Students, and Prof. R. Nagarajan Dean,
                        International & Alumni Relations. This was followed by
                        the unveiling of the competition teams – Team Raftar,
                        Anveshak and Abhiyaan.
                      </p>
                      <br />
                      <p className=" font2">
                        The Press Conference was well attended by several
                        sponsors of the competition teams and major media
                        bodies.
                      </p>
              ...
              <div className="main_teams_content fix">
                <div className="col-md-6">
                  <div className="teams_item ">
                    ...
                    <p className="font2">
                      On 29th October 2017, CFI managed to achieve yet another
                      remarkable feat. CFI entered the India Book of Records and
                      Asia Book of Records for the most robots cleaning an area
                      with 45 robots on a 72 square metre area (in Students
                      Activities Centre (SAC)), simultaneously for over fifteen
                      minutes! As many as 250 belonging to several disciplines
                      fabricated these robots at the CFI Workshop.
                    </p>
                    <br />
                    <p className="font2">
                      The cleaning robots consisted of a high-RPM motor at its
                      heart with two rotating scrub pads shovelling the dust
                      into the central suction system and a filter in the vacuum
                      tunnel collecting the waste.The robots were controlled
                      over Bluetooth by an app created for the Android system. A
                      proximity ultrasound fixed to the robots ensured that they
                      did not collide.No manual intervention was allowed inside
                      the cleaning area during the exercise.
                    </p>
                  </div>
                </div>
                <div className="col-md-6">
                        ...
                        <div className="service_slid">
                          ...
                          <div className="service_slid_item text-center">
                            <div className="service_slid_text">
                              ...
                              <img
                                src={require("./components/images/events.jpg")}
                                alt=""
                              />
                              <h5 className="text-black m-top-20">
                                Record Breaks
                              </h5>
                            </div>
                            {/* <div className="service_slid_text">
                ...
                <div className="col-md-4">
                  <div className="widget_item widget_newsletter sm-m-top-50">
                    ...
                    <div className="widget_brand m-top-10">
                      ...
                      <p className="font1" style={{ color: "white" }}>
                        {" "}
                        <span style={{ color: "#d93936" }}> Center </span>{" "}
                        <span style={{ color: "#d93936" }}>
                          For Innovation , IIT Madras.
                        </span>
                      </p>
                    </div>
